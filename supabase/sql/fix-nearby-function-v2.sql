-- Fix get_nearby_locations function - Simplified version for current table structure
-- This version works with the actual locations table structure

-- Drop existing function
DROP FUNCTION IF EXISTS get_nearby_locations(DECIMAL, DECIMAL, INTEGER);

-- Create corrected function with only existing columns
