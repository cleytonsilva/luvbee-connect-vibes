-- Migration: Fix get_places_nearby phone and website column error
-- Date: 2025-02-19
-- Description: Removes reference to non-existent 'phone' and 'website' columns in get_places_nearby function
--              Fixes error: column l.phone does not exist
...
COMMENT ON FUNCTION get_places_nearby IS 'Returns locations within a radius filtered by user preferences. Fixed to remove invalid phone and website columns.';
