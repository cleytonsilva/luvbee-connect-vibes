-- Migration: Fix get_places_nearby opening_hours column error
-- Date: 2025-02-19
-- Description: Removes reference to non-existent 'opening_hours' column in get_places_nearby function
--              Fixes error: column l.opening_hours does not exist
...
COMMENT ON FUNCTION get_places_nearby IS 'Returns locations within a radius filtered by user preferences. Fixed to remove invalid opening_hours column.';
